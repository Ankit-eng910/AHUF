...
class OrderTrackingAPIView(APIView):
    ...
    def get(self, request, order_id):
        ...
        # Assuming `order.delivery_boy` is FK to DeliveryBoy model
        delivery_location = None
        if order.delivery_boy:
            delivery_location = {
                "lat": order.delivery_boy.current_latitude,
                "lng": order.delivery_boy.current_longitude
            }
        ...
        return Response({
            ...
            "is_party_catering": order.cart_id.is_party_catering,
            "address": AddressSerializer(order.address_id).data if order.address_id else None
        })
